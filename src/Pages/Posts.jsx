   ...
   setfinaldata(joinallarray)
    ...
    return <>
            
        {
            ...
            <div className=' max-3lg: mt-20 max-3sm:ml-20'>
            <Loading />    
            </div>
            ...
            loading ?
...

                {
                    finaldata?.map((e, i) => (
                        ...
                        <div className='mb-2'>
                            <p className='mb-2 font-semibold flex gap-1 max-sm:px-2'><span>0</span><span>likes</span></p>
                            <div className='break_width'>
                                    <span className=' font-semibold'>{e.username}</span> <span>{e.desc}
                            </span>
                            </div>
