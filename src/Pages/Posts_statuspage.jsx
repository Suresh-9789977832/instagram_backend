...
function Posts_statuspage() {
  ...
  useEffect(() => {
    ...
    const getfollowedusers = async (req,res) => {
      try {
        let res = await axios.get(`${env.BASE_URL}/user/getfollowedusers/${token}`)
        setfollowedusers(res.data.map((e) => e.posts))
        setloading(false)
      } catch (error) {
  ...
  return (
    <div className='mt-[-10px] max-3sm:mt-[-40px]'>
      <div className='flex justify-center'>
        <div className="fixed h-16 top-0 z-10 bg-white text-black  shadow-sm w-full hidden justify-center items-center max-3ssm:mr-20 max-3sssm:pr-20 max-3sm:hidden">
         ...
         <div className="flex flex-row items-center  max-3sm:mt-14">
           <div className='flex  flex-col'>
             <div>
              <Posts users={followedusers} loading={loading} />
                        </div>
         </div>
         </div>
   
         <div className='pl-16 max-3lg:hidden'>
             <Profile_suggestpage/>
         </div>
...
export default Posts_statuspage
