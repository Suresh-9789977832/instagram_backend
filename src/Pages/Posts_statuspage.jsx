  ...
  return (
    <div className=''>
      <div className='flex justify-center'>
        <div className="fixed h-16 top-0 z-10 bg-white text-black  shadow-sm w-full hidden justify-center items-center max-3sm:flex max-3ssm:mr-20 max-3sssm:pr-20">
