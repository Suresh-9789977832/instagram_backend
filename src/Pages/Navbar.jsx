...
import { Usercontext } from '../Components/Context';
 ...
 function Navbar() {
    ...
    return <>
        ...
        <div className=' ml-3 mt-10 flex flex-col  h-screen'>
            <div className='fixed'> 
            <div className='mb-8 cursor-pointer pl-3 hidden max-3lg:block'>
            ...
            <div className='mb-8 cursor-pointer pl-3 max-3lg:hidden'>
            ...
            <div className='flex flex-col gap-2 '>
                <Link to={'/index'} className='flex items-center gap-4 cursor-pointer hover:bg-gray-100 w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12'>
                    <span className=' transform group-hover:scale-110 transition duration-70 ease-out'>
                        <div class="x9f619 xjbqb8w x78zum5 x168nmei x13lgxp2 x5pf9jr xo71vjh x1n2onr6 x1plvlek xryxfnj x1c4vz4f x2lah0s xdt5ytf xqjyukv x1qjc9v5 x1oa3qoh x1nhvcw1">
                            <div class="x9f619 xxk0z11 x11xpdln xvy4d1p x1o5bo1o x1eub6wo x19c4wfv">
                    ...
                    <span className=' font-bold max-3lg:hidden'>Home</span>
                </Link>

                <div className='flex items-center gap-4 cursor-pointer hover:bg-gray-100  w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12'>
                    <span className='transform group-hover:scale-110 transition duration-70 ease-out'>
                    ...
                    <span className='max-3lg:hidden'>Search</span>
                </div>

                <Link to={'/explore'} className='flex items-center gap-4 cursor-pointer hover:bg-gray-100 w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12'>
                    <span className='transform group-hover:scale-110 transition duration-70 ease-out'>
                    ...
                    <span className='max-3lg:hidden'>Explore</span>
                </Link>
                ...
                <span className='max-3lg:hidden'>Reels</span>
                </div>
                ...
                <span className='max-3lg:hidden'>Messages</span>
                </div>
                ...
                <span className='max-3lg:hidden'>Notifications</span>
                </div>

                <Link to={'/create'} className='flex items-center gap-4 cursor-pointer hover:bg-gray-100 w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12' >     
                    <span className='transform group-hover:scale-110 transition duration-70 ease-out'>
                    <svg aria-label="New post" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>New post</title><path d="M2 12v3.45c0 2.849.698 4.005 1.606 4.944.94.909 2.098 1.608 4.946 1.608h6.896c2.848 0 4.006-.7 4.946-1.608C21.302 19.455 22 18.3 22 15.45V8.552c0-2.849-.698-4.006-1.606-4.945C19.454 2.7 18.296 2 15.448 2H8.552c-2.848 0-4.006.699-4.946 1.607C2.698 4.547 2 5.703 2 8.552Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="6.545" x2="17.455" y1="12.001" y2="12.001"></line><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="12.003" x2="12.003" y1="6.545" y2="17.455"></line></svg>
                        ...
                        <span className='max-3lg:hidden'>Create</span>
                    </Link>
                ...
                <Link Link to={`/profile/${token}/${id}`} className='flex items-center gap-4 cursor-pointer hover:bg-gray-100 w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12'>
                        <span className='transform group-hover:scale-110 transition duration-70 ease-out'><img src={user.profilepicurl} className=' rounded-full  w-6 h-6 object-cover' /></span>
                ...
                <span className='max-3lg:hidden'>Profile</span>
                    ...
                    <div className='mt-10 flex flex-col gap-3'>
                        ...
                        <div className='flex items-center gap-4 cursor-pointer hover:bg-gray-100 w-72 h-12 rounded-md pl-3 group max-3xl:w-56 max-3lg:hover:w-12' onClick={logout}>
                            <CiLogout className='transform group-hover:scale-110 transition duration-70 ease-out' size={25}/>
                    <span className='max-3lg:hidden'>Logout</span>
                        </div>
